package EPrints::Plugin::Screen::REF_Support::Report::Former_Staff;
...
sub properties_from
{
	...
	$self->{processor}->{report} = 'ref1_former_staff';
...
sub render_user
{
	...
	$chunk->appendChild( $user->render_citation( 'ref_support_former_staff' ) );
