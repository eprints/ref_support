...
unshift @{$c->{'ref_support'}->{'reports'}}, ( 'Complete_Submission', 'Research_Groups', 'Current_Staff', 'Former_Staff', 'Former_Staff_Contracts', 'Research_Outputs', 'Staff_Outputs', 'REF4', 'REF1a', 'REF1b', 'REF1c', 'REF2' );
